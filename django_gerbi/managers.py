...
from django_gerbi.utils import normalize_url, filter_link
from django_gerbi.http import get_slug
...
class PageManager(models.Manager):
    ...
    def populate_pages(self, parent=None, child=5, depth=5):
        """Create a population of :class:`Page <django_gerbi.models.Page>`
        for testing purpose."""
        from django_gerbi.models import Content
    ...
    def published(self):
        ...
        :class:`Page <django_gerbi.models.Page>`."""
    ...
    def from_path(self, complete_path, lang, exclude_drafts=True):
        """Return a :class:`Page <django_gerbi.models.Page>` according to
        the page's path."""
...
class ContentManager(models.Manager):
    ...
    def set_or_create_content(self, page, language, ctype, body):
        """Set or create a :class:`Content <django_gerbi.models.Content>` for a
    ...
    def create_content_if_changed(self, page, language, ctype, body):
        """Create a :class:`Content <django_gerbi.models.Content>` for a particular
    ...
    def get_content_object(self, page, language, ctype):
        """Gets the latest published :class:`Content <django_gerbi.models.Content>`
    ...
    def get_content_slug_by_slug(self, slug):
        """Returns the latest :class:`Content <django_gerbi.models.Content>`
...
class PageAliasManager(models.Manager):
    """:class:`PageAlias <django_gerbi.models.PageAlias>` manager."""

    def from_path(self, request, path, lang):
        """
        Resolve a request to an alias. returns a
        :class:`PageAlias <django_gerbi.models.PageAlias>` if the url matches
        ...
        :param lang: not used
        """
        from django_gerbi.models import PageAlias
