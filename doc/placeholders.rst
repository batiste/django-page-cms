...
the contact form is ´gerbi/contact.html´.
...
you can simply subclass the :class:`PlaceholderNode <gerbi.placeholders.PlaceholderNode>`::

    from gerbi.placeholders import PlaceholderNode
    from gerbi.templatetags.page_tags import parse_placeholder
...
If you want to just redefine the widget of the default :class:`PlaceholderNode <gerbi.placeholders.PlaceholderNode>`
...
More examples of custom widgets are available in :mod:`gerbi.widgets.py <gerbi.widgets>`.
...
A simple line input with Django admin CSS styling (better for larger input fields)::
    ...
    {% placeholder [name] with AdminInputWidget %}
...
If you want the full version you can get it there::
    ...
    gerbi/media/gerbi.edit_area -r29 https://editarea.svn.sourceforge.net/svnroot/editarea/trunk/edit_area
