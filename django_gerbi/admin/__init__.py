...
from django_gerbi.admin.views import list_pages_ajax
from django_gerbi.admin.views import change_status, modify_content, delete_content
from django_gerbi.admin.views import move_page
from django_gerbi.permissions import PagePermission
from django_gerbi.http import auto_render
import django_gerbi.widgets
...
class PageAdmin(admin.ModelAdmin):
    ...
    def i18n_javascript(self, request):
        ...
        """
        return javascript_catalog(request, packages='django_gerbi')

    def save_model(self, request, page, form, change):
        """Move the page in the tree if necessary and save every
        placeholder :class:`Content <django_gerbi.models.Content>`.
        """
    ...
    def get_form(self, request, obj=None, **kwargs):
        """Get a :class:`Page <django_gerbi.admin.forms.PageForm>` for the
        :class:`Page <django_gerbi.models.Page>` and modify its fields depending on
        the request."""
