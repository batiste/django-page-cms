...
from django_gerbi import settings as gerbi_settings
from django_gerbi.models import Content, Page
from django_gerbi.placeholders import PlaceholderNode, ImagePlaceholderNode, FilePlaceholderNode
from django_gerbi.placeholders import VideoPlaceholderNode, ContactPlaceholderNode
from django_gerbi.placeholders import parse_placeholder
...
def show_content(context, page, content_type, lang=None, fallback=True):
    ...
    return {'content': _get_content(context, page, content_type, lang,
                                                                fallback)}
show_content = register.inclusion_tag('django_gerbi/content.html',
...
show_slug_with_level = register.inclusion_tag('django_gerbi/content.html',
...
def show_absolute_url(context, page, lang=None):
    ...
    if url:
        return {'content': url}
    return {'content': ''}
show_absolute_url = register.inclusion_tag('django_gerbi/content.html',
...
show_revisions = register.inclusion_tag('django_gerbi/revisions.html',
...
def gerbi_dynamic_tree_menu(context, page, url='/'):
    ...
    Override ``django_gerbi/dynamic_tree_menu.html`` if you want to change the
    design.
...
def gerbi_breadcrumb(context, page, url='/'):
    ...
    Override ``django_gerbi/breadcrumb.html`` if you want to change the
    design.
