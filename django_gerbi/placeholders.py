...
from django_gerbi.widgets_registry import get_widget
from django_gerbi import settings
from django_gerbi.models import Content
from django_gerbi.widgets import ImageInput, VideoWidget, FileInput
...
class PlaceholderNode(template.Node):
    ...
    :param widget: the widget you want to use in the admin interface. Take
        a look into :mod:`django_gerbi.widgets` to see which widgets
        are available.
...
class ContactPlaceholderNode(PlaceholderNode):
    ...
    def render(self, context):
        ...
        if request.method == 'POST':
            ...
            form = ContactForm()
        renderer = render_to_string('django_gerbi/contact.html', {'form':form})
...
class VideoPlaceholderNode(PlaceholderNode):
    ...
    def render(self, context):
        ...
        if content:
            ...
            renderer = render_to_string('django_gerbi/embed.html', context)
            return mark_safe(renderer)
        return ''
