...
from django_gerbi.testproj import test_settings
...
class TestCase(TestCase):
    ...
    def reset_urlconf(self):
        ...
        reload(import_module('django_gerbi.urls'))
        reload(import_module('django_gerbi.testproj.urls'))
        clear_url_caches()
    ...
    def create_new_page(self, client=None, draft=False):
        ...
        response = client.post('/admin/django_gerbi/page/add/', page_data)
