...
class RegressionTestCase(TestCase):
    ...
    def test_slug_bug(self):
        ...
        response = c.get('/django_gerbi/page1/')
    ...
    def test_bug_152(self):
        ...
        self.assertEqual(
            str(get_placeholders('django_gerbi/tests/test1.html')),
    ...
    def test_bug_162(self):
        ...
        temp = loader.get_template('django_gerbi/tests/test2.html')
    ...
    def test_bug_172(self):
        ...
        from django_gerbi.utils import get_request_mock
        request = get_request_mock()
        temp = loader.get_template('django_gerbi/tests/test3.html')
    ...
    def test_page_id_in_template(self):
        ...
        from django_gerbi.utils import get_request_mock
        request = get_request_mock()
        temp = loader.get_template('django_gerbi/tests/test4.html')
        render = temp.render(RequestContext(request, {}))
    ...
    def test_bug_178(self):
        ...
        from django_gerbi.utils import get_request_mock
        request = get_request_mock()
        temp = loader.get_template('django_gerbi/tests/test5.html')
    ...
    def test_urls_in_templates(self):
        ...
        page = self.create_new_page()
        from django_gerbi.http import get_request_mock
        request = get_request_mock()
        temp = loader.get_template('django_gerbi/tests/test7.html')
        temp = loader.get_template('django_gerbi/tests/test6.html')
    ...
    def test_placeholder_bug(self):
        ...
        template = django.template.loader.get_template('django_gerbi/tests/extends.html')
        ...
        from django_gerbi.utils import get_placeholders
        self.assertEqual(
            str(get_placeholders('django_gerbi/tests/extends.html')),
