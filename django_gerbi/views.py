...
from django_gerbi.models import Page, PageAlias
from django_gerbi.http import auto_render, get_language_from_request, remove_slug
from django_gerbi.urlconf_registry import get_urlconf
...
class Details(object):
    ...
    def __call__(self, request, path=None, lang=None, delegation=True,
        ...
        if path is None:
            raise ValueError(
                "django_gerbi.views.Details class view requires the path argument. "
