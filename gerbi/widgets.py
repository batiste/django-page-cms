...
class RichTextarea(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'gerbi/widgets/richtextarea.html', context))
...
class CKEditor(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'gerbi/widgets/ckeditor.html', context))
...
class WYMEditor(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'gerbi/widgets/wymeditor.html', context))
...
class markItUpMarkdown(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'gerbi/widgets/markitupmarkdown.html', context))
...
class markItUpRest(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'gerbi/widgets/markituprest.html', context))
...
class markItUpHTML(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'gerbi/widgets/markituphtml.html', context))
...
class EditArea(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'gerbi/widgets/editarea.html', context))
...
class LanguageChoiceWidget(TextInput):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return mark_safe(render_to_string(
            'gerbi/widgets/languages.html', context))
