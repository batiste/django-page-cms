...
from gerbi.http import get_language_from_request, get_template_from_request
from gerbi.utils import get_placeholders
from gerbi.templatetags.gerbi_tags import PlaceholderNode
from gerbi.admin.utils import get_connected, make_inline_admin
from gerbi.admin.forms import PageForm
from gerbi.admin.views import traduction, get_content, sub_menu
...
class PageAdmin(admin.ModelAdmin):
    ...
    from gerbi.urlconf_registry import registry
    if(len(registry)):
    ...
    def list_pages(self, request, template_name=None, extra_context=None):
        ...
        if settings.GERBI_HIDE_SITES:
            page_set = gerbi.filter(sites=settings.SITE_ID)
