...
from django_gerbi.urlconf_registry import get_choices
from django_gerbi.widgets import LanguageChoiceWidget
...
it must be unique among the other django_gerbi of the same level.')
    )
    ...
    def clean_slug(self):
        """Handle move action on the django_gerbi"""
