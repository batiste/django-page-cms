...
class CKEditor(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'django_gerbi/widgets/ckeditor.html', context))
...
class WYMEditor(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'django_gerbi/widgets/wymeditor.html', context))
...
class markItUpMarkdown(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'django_gerbi/widgets/markitupmarkdown.html', context))
...
class markItUpRest(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'django_gerbi/widgets/markituprest.html', context))
...
class markItUpHTML(Textarea):
    ...
    def render(self, name, value, attrs=None, **kwargs):
        ...
        return rendered + mark_safe(render_to_string(
            'django_gerbi/widgets/markituphtml.html', context))
