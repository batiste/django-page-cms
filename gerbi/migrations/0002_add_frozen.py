...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('gerbi_page', 'freeze_date', orm['gerbi.page:freeze_date'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('gerbi_page', 'freeze_date')
    ...
    if settings.GERBI_TAGGING:
        models['gerbi.page']['tags'] = ('tagging.fields.TagField', [], {'null': 'True'})
